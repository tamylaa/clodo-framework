# Secret Distribution for api1.com (development)

Generated: 2025-10-28T09:30:39.574Z
Secret Count: 10
...
```bash
# Rotate all secrets
node scripts/shared/secret-generator.js --domain api1.com --environment development --rotate-all

# Rotate specific secret
node scripts/shared/secret-generator.js --domain api1.com --environment development --rotate AUTH_JWT_SECRET
```

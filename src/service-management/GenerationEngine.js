 ...
 * 67+ configuration files and components for a complete Lego Framework service.
 *
 * Core Inputs (6):
 * 1. Service Name
 * 2. Service Type
...
export class GenerationEngine {
  ...
  async generateService(coreInputs, confirmedValues, options = {}) {
    ...
    try {
      ...
      console.log(`📋 Service manifest created: lego-service-manifest.json`);
...
${confirmedValues.author} - Generated by Lego Framework v3.0.0
...
This guide covers deploying ${confirmedValues.displayName} to different environments using the Lego Framework.

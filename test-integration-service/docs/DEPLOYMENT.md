# Test Integration Service - Deployment Guide

## Overview

This guide covers deploying Test Integration Service to different environments using the Clodo Framework.

## Environments

### Development
- **URL**: https://test-integration-service-dev.test.clodo.dev
- **Environment**: development
- **Configuration**: `config/development.env`

### Staging
- **URL**: https://test-integration-service-sta.test.clodo.dev
- **Environment**: staging
- **Configuration**: `config/staging.env`

### Production
- **URL**: https://test-integration-service.test.clodo.dev
...
1. **Clone and setup**:
   ```bash
   git clone https://github.com/tamylaa/test-integration-service
...
```bash
curl https://test-integration-service.test.clodo.dev/health
```

...
<#
.SYNOPSIS
    Setup Test Integration Service environment

.DESCRIPTION
    Initializes the development environment for Test Integration Service
...
Write-Host "🔧 Setting up Test Integration Service development environment" -ForegroundColor Cyan

...
<#
.SYNOPSIS
    Deploy Test Integration Service to Cloudflare

.DESCRIPTION
    Automated deployment script for Test Integration Service
...
Write-Host "🚀 Deploying Test Integration Service to $Environment" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "🌐 Service URL: https://test-integration-service.test.clodo.dev" -ForegroundColor Cyan

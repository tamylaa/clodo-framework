...
<#
.SYNOPSIS
    Deploy Test Api Service to Cloudflare

.DESCRIPTION
    Automated deployment script for Test Api Service
...
Write-Host "🚀 Deploying Test Api Service to $Environment" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "🌐 Service URL: https://test-api-service.test.example.com" -ForegroundColor Cyan

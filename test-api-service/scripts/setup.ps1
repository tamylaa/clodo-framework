...
<#
.SYNOPSIS
    Setup Test Api Service environment

.DESCRIPTION
    Initializes the development environment for Test Api Service
...
Write-Host "🔧 Setting up Test Api Service development environment" -ForegroundColor Cyan

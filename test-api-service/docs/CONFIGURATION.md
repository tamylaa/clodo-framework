# Test Api Service - Configuration Guide

## Overview

Test Api Service is configured using multiple layers of configuration files and environment variables.
...
PRODUCTION_URL=https://test-api-service.test.example.com
STAGING_URL=https://test-api-service-sta.test.example.com
DEVELOPMENT_URL=https://test-api-service-dev.test.example.com
DOCUMENTATION_URL=https://docs.test.example.com

# API Configuration
API_BASE_PATH=/api/v1/test/api-service
...
export const domains = {
  'test-api-service': {
    ...
    metadata: {
      ...
      generatedAt: '2026-02-04T03:49:23.783Z',
...
[env.development]
name = "test-api-service-worker-dev"

[env.staging]
name = "test-api-service-worker-staging"
